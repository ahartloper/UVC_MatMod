...
uniaxialMaterial RESSCppLab 1 179800.0 318.5 100.7 8.0 0.0 1.0 2 11608.2 145.2 1026.0 4.7
...
recorder Node -file Structure_Disp_x_Node_3.out -time -node 3 -dof 1 disp

# create a Recorder for element forces, one for global system and the other for local system
recorder Node -file Structure_Force_x_Node_1.out -time -node 1 -dof 1 reaction
